...
import com.example.bob_friend_android.data.entity.PasswordReset
...
interface UserRepository {
    ...
    suspend fun updateUserPassword(passwordReset: HashMap<String, String>) : NetworkResponse<Void, ErrorResponse>
}